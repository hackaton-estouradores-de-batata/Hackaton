...
| 5 | Monitoramento de efetividade | dashboard + `src/scripts/eval_policy.py` no Sprint 6 |
...
- [x] `src/scripts/analyze_historical.py` com leitura do histórico
...
- [ ] Camada 6.2: `src/scripts/eval_policy.py`
...
- `src/policy/acordos_v1.yaml` permanece no repositório como legado, mas não representa mais o runtime principal.

---

## 12. Próximos Passos

1. Implementar `src/scripts/eval_policy.py` com saída pronta para `docs/slides`.
