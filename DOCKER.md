...
- lê a política em `policy/acordos_v1.yaml` via mount em `/workspace/policy`
...
- a política carregada pelo backend vem de `policy/`
...
Cheque também o healthcheck e os mounts de `data/` e `policy/`.
